...
from aquacrop.solution.water_stress import water_stress

def compileLibrary():
    try:
        from ..solution.solution_aeration_stress import aeration_stress
        from ..solution.solution_water_stress import water_stress
        from ..solution.solution_evap_layer_water_content import evap_layer_water_content
        ...
        print(" Note: The compilation is only necessary the first time that the library is used.")
